...
struct KeychainItem {
    ...
    static var currentRefreshToken: String {
         do {
             let storedIdentifier = try KeychainItem(service: Bundle.main.bundleIdentifier!, account: "refreshToken").readItem()
             return storedIdentifier
         } catch {
             return ""
         }
    ...
    static func deleteRefreshTokenFromKeychain() {
        do {
            ...
            print("Unable to delete refreshToken from keychain")
        }
    }
    
    static func deleteAllKeychainIdentifiers() {
        do {
            try KeychainItem(service: Bundle.main.bundleIdentifier!, account: "userIdentifier").deleteItem()
            try KeychainItem(service: Bundle.main.bundleIdentifier!, account: "refreshToken").deleteItem()
